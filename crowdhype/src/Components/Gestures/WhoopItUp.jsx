...
const WhoopItUp  = ({
  ...
  const pathPosition1 = new THREE.Vector3(-2.3, 2.5, zPosition);
  const pathRotation1 = new THREE.Euler(Math.PI, 0, 0);
  const pathPosition2 = new THREE.Vector3(2.3, 2.5, zPosition);
  const pathRotation2 = new THREE.Euler(Math.PI, Math.PI, 0);

  const conePosition1 = new THREE.Vector3(-0.6, 2.6, zPosition);
  const coneRotation1 = new THREE.Euler(0, 0, 0);
  const conePosition2 = new THREE.Vector3(0.6, 2.6, zPosition);
  const coneRotation2 = new THREE.Euler(0, 0, -0);

  const endPosition1 = new THREE.Vector3(-0.6, 2.85, zPosition);
  const endPosition2 = new THREE.Vector3(0.6, 2.85, zPosition);
