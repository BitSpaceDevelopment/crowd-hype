...
const ToTheLeft = ({
  ...
  const fontSize = 0.24;
  const numPointsActualPath1 = 15;
  const numPointsActualPath2 = 35;
  ...
  const pathRadius2 = 2.4;
  const pathArc2 = Math.PI / 2;
  const pathPosition2 = new THREE.Vector3(-1.8, 1, zPosition);
  const pathRotation2 = new THREE.Euler(0, 0, 0);

  const conePosition1 = new THREE.Vector3(-2, 2, zPosition);
  const coneRotation1 = new THREE.Euler(0, 0, Math.PI / 2);
  const conePosition2 = new THREE.Vector3(-2, 3.4, zPosition);
  const coneRotation2 = new THREE.Euler(0, 0, Math.PI / 2);

  const endPosition1 = new THREE.Vector3(-2.3, 2, zPosition);
  const endPosition2 = new THREE.Vector3(-2.3, 3.4, zPosition);
